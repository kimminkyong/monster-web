...
(function (global, factory) {
    ...
    niceDatePicker.prototype.buildUi = function (year, month) {
        ...
        this.dayWords = [['一', '二', '三', '四', '五', '六', '日'], ['Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su'], ['월', '화', '수', '목', '금', '토', '일']];
        ...
        if (!this.$params.mode) {
            ...
            html += '<span class="nice-date-title">' + this.monthData.year + '年 - ' + this.monthData.month + '月</span>';
        }else if (this.$params.mode === 'kr') {
            html += '<span class="nice-date-title">' + this.monthData.year + '년 - ' + this.monthData.month + '월</span>';
        }
